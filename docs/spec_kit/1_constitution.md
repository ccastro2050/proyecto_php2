...
```
CAPA 1: FRONT (PHP, :8024)   — solo pinta HTML y llama la API; NUNCA toca la BD
CAPA 2: API  (PHP, :8026)    — api_facturas; solo JSON, nunca HTML
...
| Cosa | Convención |
|---|---|
| Puertos públicos | front **8024** · api_facturas **8026** |
| Puertos de BD hacia el host | MariaDB **13327** (PostgreSQL y SQL Server llegan en v3 y v4, con los suyos) |
